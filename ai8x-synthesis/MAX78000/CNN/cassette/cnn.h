...
/*
 * This header file was automatically @generated for the cassette network from a template.
...
/*
  SUMMARY OF OPS
  Hardware: 51,376,128 ops (50,439,168 macc; 936,960 comp; 0 add; 0 mul; 0 bitwise)
    ...
    Layer 6: 9,216 ops (9,216 macc; 0 comp; 0 add; 0 mul; 0 bitwise)

  RESOURCE USAGE
  Weight memory: 64,944 bytes out of 442,368 bytes total (14.7%)
  Bias memory:   9 bytes out of 2,048 bytes total (0.4%)
*/

/* Number of outputs for this network */
#define CNN_NUM_OUTPUTS 9
